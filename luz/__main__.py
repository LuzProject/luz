...
def main():
    ...
    parser.add_argument("-v", "--version", action="version", version=f"luz v{get_version()}", help="show current version and exit")
    ...
    parser_build.add_argument("-c", "--clean", action="store_true", help="clean the project before building", required=False)
