    ...
    def __stage(self):
        ...
        if self.module.install_dir is None:
            dirtomake = resolve_path(
                f"{self.luz.build_dir}/_/Library/MobileSubstrate/DynamicLibraries") if not self.meta.rootless else resolve_path(f"{self.luz.build_dir}/_/var/jb/Library/MobileSubstrate")
            dirtocopy = resolve_path(
                f"{self.luz.build_dir}/_/Library/MobileSubstrate/DynamicLibraries") if not self.meta.rootless else resolve_path(f"{self.luz.build_dir}/_/var/jb/Library/MobileSubstrate/DynamicLibraries")
        else:
