...
def get_sdks():
    ...
    res = getoutput(f'sudo --user "{environ.get("SUDO_USER")}" mkdir -p {sdk_path} && sudo --user "{environ.get("SUDO_USER")}" {cmd_in_path("git")} clone https://github.com/xybp888/iOS-SDKs.git {sdk_path}')
